						...
						foreach($numerosnivel3 as $dezena4)
						{
							...
							foreach($numerosnivel4 as $dezena5)
							{
								...
								foreach($numerosnivel5 as $dezena6)
								{
									...
									if ($nrColunas == 6 and $nrLinhas > 3 and $nrLinha1 < 3){
